...
public: //--------------| generation
	...
	template<typename Q>
	TQuat(const TQuat<Q>& r) : x(r.x), y(r.y), z(r.z), w(r.w)
	{}

	template<typename Q, typename R>
	TQuat(const TVector<Q>& v, R angle)
	{ 
	...
	template<typename Q>
	SSQuat& operator=(const TQuat<Q>& r) { QUAT_QUAT((*this), r, =, STATE); }
	      T& operator[](int i)       { switch (i) { case 0: return x; case 1: return y; case 2: return z; case 3: return w; } throw std::out_of_range("Invalid index"); }
	const T& operator[](int i) const { switch (i) { case 0: return x; case 1: return y; case 2: return z; case 3: return w; } throw std::out_of_range("Invalid index"); }
...
public: //~~~~~~~~~~~~~~| equation
	template<typename Q> bool operator==(const TQuat<Q>& r) const { return QUAT_SCALAR((*this), r, == , &); }
